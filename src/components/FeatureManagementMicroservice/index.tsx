...
function FeatureManagementMicroservice() {
  ...
  const handleTabChange = (newTab: string, gridApi: any) => {
    ...
    } else if (newTab === TABS[4]) {
      newUserConfig = userRolesConfig;
      newColumns = columns.slice(6, 10);
    }
...
export default FeatureManagementMicroservice;
